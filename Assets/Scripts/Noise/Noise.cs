...
public class Noise
{
    ...
    void Randomize(int _seed)
    {
        ...
        if (_seed != 0)
        {
            ...
            UnpackLittleUint32(_seed, ref f);
    ...
    static double Dot(int[] _g, double _x, double _y, double _z, double _t) => _g[0] * _x + _g[1] * _y + _g[2] * _z + _g[3] * _t;

    static double Dot(int[] _g, double _x, double _y, double _z) => _g[0] * _x + _g[1] * _y + _g[2] * _z;

    static double Dot(int[] _g, double _x, double _y) => _g[0] * _x + _g[1] * _y;

    static int FastFloor(double _x) => _x >= 0 ? (int) _x : (int) _x - 1;
    ...
    /// <param name="_buffer">The output buffer.</param>
    static byte[] UnpackLittleUint32(int _value, ref byte[] _buffer)
    {
        if (_buffer.Length < 4)
        {
        ...
        _buffer[0] = (byte) (_value & 0x00ff);
        _buffer[1] = (byte) ((_value & 0xff00) >> 8);
        _buffer[2] = (byte) ((_value & 0x00ff0000) >> 16);
        _buffer[3] = (byte) ((_value & 0xff000000) >> 24);
